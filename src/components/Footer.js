...
export default function Footer({mode}) {
  return (
    <MDBFooter className={`text-center text-${mode==='dark'?"dark":"white"}`} style={{ backgroundColor: mode==='dark'?'black':'white' }}>
      <MDBContainer className='pt-4'>
        <section className='mb-4'>
          ...
          <MDBBtn
            ...
            size="lg"
            className='text-dark m-1'
            href='https://www.tiktok.com/razu.sharmaa/'
            role='button'
          >
      ...
      <div className='text-center text-dark p-3' style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
        © 2024 Copyright: 
        <a className='text-dark' href='https://razusharmaa.github.io/Esewa-QrGenerator/ '>
          QrCodeGenerator.com
        </a>
      </div>
    </MDBFooter>
